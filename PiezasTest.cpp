...
TEST(PiezasTest, gameStateXWinsCol1) {
	Piezas board;
	board.dropPiece(1);
	board.dropPiece(0);
	board.dropPiece(1);
...
TEST(PiezasTest, gameStateXWinsCol3) {
	Piezas board;
	board.dropPiece(2);
	board.dropPiece(0);
	board.dropPiece(3);
...
TEST(PiezasTest, gameStateOWinsCol0) {
	Piezas board;
	board.dropPiece(1);
	board.dropPiece(0);
	board.dropPiece(2);
...
TEST(PiezasTest, gameStateOWinsCol1) {
	Piezas board;
	board.dropPiece(0);
	board.dropPiece(1);
	board.dropPiece(2);
...
TEST(PiezasTest, gameStateOWinsCol2) {
	Piezas board;
	board.dropPiece(0);
	board.dropPiece(2);
	board.dropPiece(1);
